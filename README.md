...
<p align="center">
  ...
  <h1 align="center">Purchase Smart Contract</h1>
  <p align="center">
    Blockchain
    <br />
...
There's a couple of problems when it comes to make a safe remote purchase when there's no intermediaries to trust because the issue arises with shipment because there's no way to determine for sure that an item arrived at the buyer.

One way to solve this shipment inconvenient is to give an incentive to the buyer and seller to locked the double of the price of the purchase value.
Once the item is received by the buyer in order to receive his money locked back, the buyer must notify that he received the item purchased.
And then the seller can get refunded too. :smile:
...
1. Clone the repo
   ```sh
   git clone https://github.com/darubiomunoz/smartcontract-purchase.git
   ```
   ```sh
   git clone git@github.com:darubiomunoz/smartcontract-purchase.git
   ```
...
Project Link: [https://github.com/darubiomunoz/smartcontract-purchase.git](https://github.com/darubiomunoz/smartcontract-purchase.git)
